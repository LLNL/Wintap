                        ...
                        try
                        {
                            if (data.ToString().ToLower().Contains("processstart") || data.ToString().ToLower().Contains("loaded") && data.ToString().ToLower().Contains(".exe"))
                            {
                                ...
                                if (data.EventName == "ProcessStart/Start")
                                {
                                    ...
                                    WintapMessage processPartial = new WintapMessage(createTime.ToUniversalTime(), processId, WintapMessage.MessageTypeEnum.PROCESS_PARTIAL) { ActivityType = WintapMessage.ActivityTypeEnum.Rundown };
                                ...
                                if (data.EventName == "ImageLoad")
                                {
                                    ...
                                    WintapMessage processPartial = new WintapMessage(DateTime.UtcNow, processId, WintapMessage.MessageTypeEnum.PROCESS_PARTIAL) { ActivityType = WintapMessage.ActivityTypeEnum.Rundown };
