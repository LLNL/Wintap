...
//                WintapLogger.Log.Append("signed s3 upload url requested for " + localFile, LogLevel.Debug);
//            }
//            catch (Exception ex)
//            {
...
//            WintapLogger.Log.Append("signed url received for file: " + iotMsg.filename, LogLevel.Debug);
